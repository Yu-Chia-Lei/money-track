...
class BookDetail(models.Model):
    ...
    book = models.OneToOneField(
        Book,
        on_delete=models.CASCADE, #關連項目被刪除時，該項目也會被刪除
        related_name='detail',
        verbose_name='書籍' #要在admin顯示中文時，需要設定verbose_name
    )
    isbn = models.CharField(max_length=13, unique=True, verbose_name='ISBN') #unique=True 表示ISBN是唯一的，不能重複
